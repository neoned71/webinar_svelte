import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, o as globals, v as validate_slots, I as get_store_value, K as ApiUrl, J as onMount, T as Token, p as validate_each_argument, e as element, f as claim_element, g as children, b as detach_dev, j as attr_dev, x as add_render_callback, k as add_location, l as insert_hydration_dev, y as select_option, A as listen_dev, C as destroy_each, D as run_all, t as text, h as claim_text, m as append_hydration_dev, u as set_data_dev, w as prop_dev, a as space, c as claim_space, n as noop, F as set_style, q as query_selector_all, E as select_value } from './client.539f099e.js';
...
function create_else_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 730, 50, 14985);
			attr_dev(button, "class", "w3-button svelte-5hvp3l");
			add_location(button, file, 730, 3, 14938);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = listen_dev(button, "click", /*toggleMic*/ ctx[10], false, false, false);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block_6(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 728, 50, 14882);
			attr_dev(button, "class", "w3-button svelte-5hvp3l");
			add_location(button, file, 728, 3, 14835);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, i);
...
function create_else_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 736, 52, 15211);
			attr_dev(button, "class", "w3-button svelte-5hvp3l");
			add_location(button, file, 736, 3, 15162);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, i);
			...
			if (!mounted) {
				dispose = listen_dev(button, "click", /*toggleVideo*/ ctx[11], false, false, false);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block_5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 734, 52, 15111);
			attr_dev(button, "class", "w3-button svelte-5hvp3l");
			add_location(button, file, 734, 3, 15062);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, i);
...
function create_else_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-5hvp3l");
			add_location(button, file, 742, 3, 15368);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			...
			if (!mounted) {
				dispose = listen_dev(button, "click", /*toggleUsers*/ ctx[12], false, false, false);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-5hvp3l");
			add_location(button, file, 740, 3, 15286);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, t);
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-5hvp3l");
			add_location(button, file, 749, 3, 15615);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, t);
			...
			if (!mounted) {
				dispose = listen_dev(button, "click", /*toggleMasters*/ ctx[13], false, false, false);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-5hvp3l");
			add_location(button, file, 747, 3, 15529);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, t);
...
// (756:2) {#if enumeratedDevices}
function create_if_block_2(ctx) {
	let select;
	let mounted;
	let dispose;
	let each_value = /*enumeratedDevices*/ ctx[7];
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(select, "class", "w3-margin w3-round w3-select w3-input w3-padding w3-opacity");
			if (/*selectedVideoDeviceId*/ ctx[1] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[17].call(select));
			add_location(select, file, 756, 2, 15881);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen_dev(select, "change", /*videoDeviceChanged*/ ctx[14], false, false, false)
				];
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*enumeratedDevices*/ 128) {
				each_value = /*enumeratedDevices*/ ctx[7];
				validate_each_argument(each_value);
				let i;
			...
			if (dirty[0] & /*selectedVideoDeviceId, enumeratedDevices*/ 130) {
				select_option(select, /*selectedVideoDeviceId*/ ctx[1]);
			}
		},
		d: function destroy(detaching) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(756:2) {#if enumeratedDevices}",
		ctx
	});
...
// (759:3) {#each enumeratedDevices as device, i}
function create_each_block(ctx) {
	let option;
	let t_value = (/*device*/ ctx[31].label || "camera " + (/*i*/ ctx[33] + 1)) + "";
	let t;
	...
	const block = {
		...
		h: function hydrate() {
			option.__value = option_value_value = /*device*/ ctx[31].deviceId;
			option.value = option.__value;
			add_location(option, file, 759, 4, 16122);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*enumeratedDevices*/ 128 && t_value !== (t_value = (/*device*/ ctx[31].label || "camera " + (/*i*/ ctx[33] + 1)) + "")) set_data_dev(t, t_value);

			if (dirty[0] & /*enumeratedDevices*/ 128 && option_value_value !== (option_value_value = /*device*/ ctx[31].deviceId)) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(759:3) {#each enumeratedDevices as device, i}",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(p, "class", "svelte-5hvp3l");
			add_location(p, file, 767, 6, 16297);
			attr_dev(button0, "class", "w3-button svelte-5hvp3l");
			add_location(button0, file, 768, 6, 16326);
			attr_dev(button1, "class", "w3-button svelte-5hvp3l");
			add_location(button1, file, 769, 6, 16402);
			attr_dev(button2, "class", "w3-button w3-red svelte-5hvp3l");
			add_location(button2, file, 771, 6, 16515);
			attr_dev(div, "class", "primary_controls svelte-5hvp3l");
			add_location(div, file, 766, 5, 16260);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen_dev(button0, "click", /*controlMuteAll*/ ctx[8], false, false, false),
					listen_dev(button1, "click", /*controlUnmuteAll*/ ctx[9], false, false, false),
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "w3-center svelte-5hvp3l");
			add_location(div0, file, 781, 3, 16667);
			add_location(h20, file, 787, 4, 16816);
			attr_dev(div1, "id", "masters");
			attr_dev(div1, "class", "masters_video svelte-5hvp3l");
			add_location(div1, file, 788, 4, 16837);
			attr_dev(div2, "id", "masters_container");
			set_style(div2, "display", /*showMasters*/ ctx[2] ? "block" : "none");
			attr_dev(div2, "class", "svelte-5hvp3l");
			add_location(div2, file, 786, 3, 16738);
			add_location(h21, file, 794, 4, 16993);
			attr_dev(div3, "id", "users");
			attr_dev(div3, "class", "users_video svelte-5hvp3l");
			add_location(div3, file, 795, 4, 17012);
			attr_dev(div4, "id", "users_container");
			set_style(div4, "display", /*showUsers*/ ctx[3] ? "block" : "none");
			attr_dev(div4, "class", "svelte-5hvp3l");
			add_location(div4, file, 793, 3, 16919);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*showMasters*/ 4) {
				set_style(div2, "display", /*showMasters*/ ctx[2] ? "block" : "none");
			}

			if (dirty[0] & /*showUsers*/ 8) {
				set_style(div4, "display", /*showUsers*/ ctx[3] ? "block" : "none");
			}
		},
		d: function destroy(detaching) {
...
function create_fragment(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*myMic*/ ctx[4]) return create_if_block_6;
	...
	function select_block_type_1(ctx, dirty) {
		if (/*myVideo*/ ctx[5]) return create_if_block_5;
	...
	function select_block_type_2(ctx, dirty) {
		if (!/*showUsers*/ ctx[3]) return create_if_block_4;
	...
	function select_block_type_3(ctx, dirty) {
		if (!/*showMasters*/ ctx[2]) return create_if_block_3;
		return create_else_block;
	}

	let current_block_type_3 = select_block_type_3(ctx);
	let if_block3 = current_block_type_3(ctx);
	let if_block4 = /*enumeratedDevices*/ ctx[7] && create_if_block_2(ctx);
	let if_block5 = /*isPrimary*/ ctx[6] && create_if_block_1(ctx);
	let if_block6 = /*user*/ ctx[0] && create_if_block(ctx);
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(p, "class", "svelte-5hvp3l");
			add_location(p, file, 725, 1, 14772);
			attr_dev(button, "class", "w3-button svelte-5hvp3l");
			add_location(button, file, 753, 2, 15783);
			attr_dev(div0, "class", "normal_controls svelte-5hvp3l");
			add_location(div0, file, 726, 1, 14788);
			attr_dev(div1, "class", "topbar w3-card svelte-5hvp3l");
			add_location(div1, file, 724, 0, 14742);
			attr_dev(div2, "class", "main svelte-5hvp3l");
			add_location(div2, file, 778, 2, 16627);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, t0, anchor);
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		...
		if (!user || !room || !socket) {
			...
			$$invalidate(6, isPrimary = user.id == room.primary);
			connectSocket();
		}
	...
	async function connectSocket() {
		try {
			...
			$$invalidate(7, enumeratedDevices = await enumerateVideoDevices());
			console.log(enumeratedDevices);
			...
			if (stream.getVideoTracks().length > 0) {
				...
				console.log(stream);
				console.log("selected device Id:" + selectedVideoDeviceId);
				$$invalidate(4, myMic = true);
				$$invalidate(5, myVideo = true);
		...
		socket.on('set-primary', data => {
			...
			if (room.primary != data.user && room.masters.includes(data.user)) {
				...
				if (user.id == data.user) {
					$$invalidate(6, isPrimary = true);
				}

				$$invalidate(15, room.primary = data.user, room);
			}
		}); // 
	...
	function toggleUsers() {
		$$invalidate(3, showUsers = !showUsers);
	}

	function toggleMasters() {
		$$invalidate(2, showMasters = !showMasters);
	}
	...
	navigator.mediaDevices.addEventListener('devicechange', async event => {
		...
		$$invalidate(7, enumeratedDevices = await getConnectedDevices('video'));
		console.log(enumeratedDevices);
	...
	async function videoDeviceChanged(e) {
		...
		let str = await getCameraStream(deviceId);
	...
	function select_change_handler() {
		...
		$$invalidate(7, enumeratedDevices);
	}

	$$self.$$set = $$props => {
		if ('socket' in $$props) $$invalidate(16, socket = $$props.socket);
		if ('user' in $$props) $$invalidate(0, user = $$props.user);
		if ('room' in $$props) $$invalidate(15, room = $$props.room);
	};
	...
	$$self.$inject_state = $$props => {
		...
		if ('showMasters' in $$props) $$invalidate(2, showMasters = $$props.showMasters);
		if ('showUsers' in $$props) $$invalidate(3, showUsers = $$props.showUsers);
		if ('myMic' in $$props) $$invalidate(4, myMic = $$props.myMic);
		if ('myVideo' in $$props) $$invalidate(5, myVideo = $$props.myVideo);
		if ('room' in $$props) $$invalidate(15, room = $$props.room);
		if ('isMaster' in $$props) isMaster = $$props.isMaster;
		if ('isPrimary' in $$props) $$invalidate(6, isPrimary = $$props.isPrimary);
		if ('enumeratedDevices' in $$props) $$invalidate(7, enumeratedDevices = $$props.enumeratedDevices);
...
class Face_screen extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, { socket: 16, user: 0, room: 15 }, null, [-1, -1]);
		...
		if (/*room*/ ctx[15] === undefined && !('room' in props)) {
