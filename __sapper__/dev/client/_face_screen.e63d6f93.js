import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, o as globals, v as validate_slots, I as get_store_value, K as ApiUrl, J as onMount, T as Token, p as validate_each_argument, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, k as add_location, j as attr_dev, x as add_render_callback, l as insert_hydration_dev, m as append_hydration_dev, y as select_option, A as listen_dev, C as destroy_each, u as set_data_dev, w as prop_dev, n as noop, a as space, c as claim_space, D as run_all, F as set_style, q as query_selector_all, E as select_value } from './client.17596a07.js';
...
function create_else_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 957, 50, 20695);
			attr_dev(button, "class", "w3-button svelte-1has07x");
			add_location(button, file, 957, 3, 20648);
		},
...
function create_if_block_9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 955, 50, 20592);
			attr_dev(button, "class", "w3-button svelte-1has07x");
			add_location(button, file, 955, 3, 20545);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, i);
...
function create_else_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 963, 52, 20921);
			attr_dev(button, "class", "w3-button svelte-1has07x");
			add_location(button, file, 963, 3, 20872);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, i);
...
function create_if_block_8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 961, 52, 20821);
			attr_dev(button, "class", "w3-button svelte-1has07x");
			add_location(button, file, 961, 3, 20772);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, i);
...
function create_else_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-1has07x");
			add_location(button, file, 969, 3, 21078);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
...
function create_if_block_7(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-1has07x");
			add_location(button, file, 967, 3, 20996);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, t);
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-1has07x");
			add_location(button, file, 976, 3, 21325);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, t);
...
function create_if_block_6(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-1has07x");
			add_location(button, file, 974, 3, 21239);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, t);
...
function create_if_block_5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(option, file, 987, 3, 21717);
			attr_dev(select, "class", "w3-black w3-round w3-select w3-input w3-padding w3-opacity svelte-1has07x");
			if (/*selectedVideoDeviceId*/ ctx[1] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[24].call(select));
			add_location(select, file, 986, 2, 21603);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(986:1) {#if enumeratedDevices}",
		ctx
	});
...
// (989:3) {#each enumeratedDevices as device, i}
function create_each_block_2(ctx) {
	let option;
	let t_value = (/*device*/ ctx[42].label || "camera " + (/*i*/ ctx[44] + 1)) + "";
	let t;
	...
	const block = {
		...
		h: function hydrate() {
			option.__value = option_value_value = /*device*/ ctx[42].deviceId;
			option.value = option.__value;
			add_location(option, file, 989, 4, 21804);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*enumeratedDevices*/ 512 && t_value !== (t_value = (/*device*/ ctx[42].label || "camera " + (/*i*/ ctx[44] + 1)) + "")) set_data_dev(t, t_value);

			if (dirty[0] & /*enumeratedDevices*/ 512 && option_value_value !== (option_value_value = /*device*/ ctx[42].deviceId)) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(989:3) {#each enumeratedDevices as device, i}",
		ctx
	});
...
// (995:1) {#if enumeratedAudioDevices}
function create_if_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			option.__value = "-";
			option.value = option.__value;
			add_location(option, file, 996, 3, 22057);
			attr_dev(select, "class", "w3-black w3-round w3-select w3-input w3-padding w3-opacity svelte-1has07x");
			if (/*selectedAudioDeviceId*/ ctx[2] === void 0) add_render_callback(() => /*select_change_handler_1*/ ctx[25].call(select));
			add_location(select, file, 995, 2, 21942);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, select, anchor);
			append_hydration_dev(select, option);
			...
			if (!mounted) {
				dispose = listen_dev(select, "change", /*select_change_handler_1*/ ctx[25]);
				mounted = true;
			}
		},
		p: function update(ctx, dirty) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(995:1) {#if enumeratedAudioDevices}",
		ctx
	});
...
// (998:3) {#each enumeratedAudioDevices as device, i}
function create_each_block_1(ctx) {
	let option;
	let t_value = (/*device*/ ctx[42].label || "audio " + (/*i*/ ctx[44] + 1)) + "";
	let t;
	let option_value_value;
	...
	const block = {
		...
		h: function hydrate() {
			option.__value = option_value_value = /*device*/ ctx[42].deviceId;
			option.value = option.__value;
			add_location(option, file, 998, 4, 22155);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, option, anchor);
			append_hydration_dev(option, t);
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*enumeratedAudioDevices*/ 1024 && t_value !== (t_value = (/*device*/ ctx[42].label || "audio " + (/*i*/ ctx[44] + 1)) + "")) set_data_dev(t, t_value);

			if (dirty[0] & /*enumeratedAudioDevices*/ 1024 && option_value_value !== (option_value_value = /*device*/ ctx[42].deviceId)) {
				prop_dev(option, "__value", option_value_value);
				option.value = option.__value;
			}
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(998:3) {#each enumeratedAudioDevices as device, i}",
		ctx
	});
...
// (1003:1) {#if enumeratedAudioDevices || enumeratedDevices}
function create_if_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button w3-green w3-margin svelte-1has07x");
			add_location(button, file, 1003, 2, 22312);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, t);
			...
			if (!mounted) {
				dispose = listen_dev(button, "click", /*deviceChanged*/ ctx[19], false, false, false);
				mounted = true;
			}
		},
		p: noop,
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(1003:1) {#if enumeratedAudioDevices || enumeratedDevices}",
		ctx
	});
...
function create_if_block_1(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*enumeratedMediaDevices*/ ctx[11] && create_if_block_2(ctx);
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(p, "class", "svelte-1has07x");
			add_location(p, file, 1011, 6, 22471);
			attr_dev(button0, "class", "w3-button svelte-1has07x");
			add_location(button0, file, 1020, 6, 22887);
			attr_dev(button1, "class", "w3-button svelte-1has07x");
			add_location(button1, file, 1021, 6, 22963);
			attr_dev(button2, "class", "w3-button w3-red svelte-1has07x");
			add_location(button2, file, 1023, 6, 23076);
			attr_dev(div, "class", "primary_controls svelte-1has07x");
			add_location(div, file, 1010, 5, 22434);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen_dev(button2, "click", /*endClass*/ ctx[18], false, false, false)
				];
		...
		p: function update(ctx, dirty) {
			if (/*enumeratedMediaDevices*/ ctx[11]) if_block.p(ctx, dirty);
		},
		d: function destroy(detaching) {
...
// (1013:6) {#if enumeratedMediaDevices}
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			option.value = option.__value;
			add_location(option, file, 1014, 8, 22695);
			attr_dev(select, "class", "w3-black w3-round w3-select w3-input w3-padding w3-opacity svelte-1has07x");
			if (/*selectedMediaDeviceId*/ ctx[3] === void 0) add_render_callback(() => /*select_change_handler_2*/ ctx[26].call(select));
			add_location(select, file, 1013, 7, 22536);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, select, anchor);
			append_hydration_dev(select, option);
			...
			if (!mounted) {
				dispose = [
					listen_dev(select, "change", /*select_change_handler_2*/ ctx[26]),
					listen_dev(select, "change", /*deviceChangeToAndFromMedia*/ ctx[20], false, false, false)
				];
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(1013:6) {#if enumeratedMediaDevices}",
		ctx
	});
...
// (1016:8) {#each enumeratedMediaDevices as device, i}
function create_each_block(ctx) {
	let option;
	let t_value = /*device*/ ctx[42] + "";
	let t;
	...
	const block = {
		...
		h: function hydrate() {
			option.__value = /*device*/ ctx[42];
			option.value = option.__value;
			add_location(option, file, 1016, 9, 22795);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, option, anchor);
			append_hydration_dev(option, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(1016:8) {#each enumeratedMediaDevices as device, i}",
		ctx
	});
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "w3-center svelte-1has07x");
			add_location(div0, file, 1033, 3, 23229);
			add_location(h20, file, 1039, 4, 23378);
			attr_dev(div1, "id", "masters");
			attr_dev(div1, "class", "masters_video svelte-1has07x");
			add_location(div1, file, 1040, 4, 23399);
			attr_dev(div2, "id", "masters_container");
			set_style(div2, "display", /*showMasters*/ ctx[4] ? "block" : "none");
			attr_dev(div2, "class", "svelte-1has07x");
			add_location(div2, file, 1038, 3, 23300);
			add_location(h21, file, 1046, 4, 23555);
			attr_dev(div3, "id", "users");
			attr_dev(div3, "class", "users_video svelte-1has07x");
			add_location(div3, file, 1047, 4, 23574);
			attr_dev(div4, "id", "users_container");
			set_style(div4, "display", /*showUsers*/ ctx[5] ? "block" : "none");
			attr_dev(div4, "class", "svelte-1has07x");
			add_location(div4, file, 1045, 3, 23481);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	let if_block6 = (/*enumeratedAudioDevices*/ ctx[10] || /*enumeratedDevices*/ ctx[9]) && create_if_block_3(ctx);
	let if_block7 = /*isPrimary*/ ctx[8] && create_if_block_1(ctx);
	let if_block8 = /*user*/ ctx[0] && create_if_block(ctx);
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(p, "class", "svelte-1has07x");
			add_location(p, file, 952, 1, 20482);
			attr_dev(button, "class", "w3-button svelte-1has07x");
			add_location(button, file, 980, 2, 21493);
			attr_dev(div0, "class", "normal_controls svelte-1has07x");
			add_location(div0, file, 953, 1, 20498);
			attr_dev(div1, "class", "topbar w3-card svelte-1has07x");
			add_location(div1, file, 951, 0, 20452);
			attr_dev(div2, "class", "main svelte-1has07x");
			add_location(div2, file, 1030, 2, 23189);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, t0, anchor);
...
function instance($$self, $$props, $$invalidate) {
	...
	function initializeSocket(socket) {
		...
		socket.on('set-primary', data => {
			...
			if (room.primary != data.user && room.masters.includes(data.user)) {
				...
				$$invalidate(21, room.primary = data.user, room);
			}
		}); // 
	...
	$$self.$$set = $$props => {
		...
		if ('roomId' in $$props) $$invalidate(23, roomId = $$props.roomId);
		if ('room' in $$props) $$invalidate(21, room = $$props.room);
	};
...
class Face_screen extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*roomId*/ ctx[23] === undefined && !('roomId' in props)) {
			console_1.warn("<Face_screen> was created without expected prop 'roomId'");
		}

		if (/*room*/ ctx[21] === undefined && !('room' in props)) {
