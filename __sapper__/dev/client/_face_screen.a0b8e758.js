...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$1, 62, 12, 1211);
			attr_dev(div1, "class", "chat");
			add_location(div1, file$1, 65, 12, 1287);
			add_location(hr, file$1, 66, 12, 1333);
			add_location(li, file$1, 61, 8, 1194);
			add_location(ul, file$1, 60, 4, 1181);
			add_location(div2, file$1, 59, 0, 1171);
			attr_dev(input, "type", "text");
			add_location(input, file$1, 82, 8, 1650);
			add_location(button, file$1, 83, 8, 1702);
			attr_dev(div3, "class", "flex svelte-g0dpjv");
			add_location(div3, file$1, 81, 4, 1623);
			attr_dev(div4, "class", "chat-input svelte-g0dpjv");
			add_location(div4, file$1, 80, 0, 1594);
		},
...
function create_each_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "name");
			add_location(div0, file$1, 70, 12, 1407);
			attr_dev(div1, "class", "chat");
			add_location(div1, file$1, 73, 12, 1485);
			add_location(hr, file$1, 74, 12, 1533);
			add_location(li, file$1, 69, 8, 1390);
		},
		m: function mount(target, anchor) {
