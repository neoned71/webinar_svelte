...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(ul, file$1, 60, 4, 1181);
			add_location(div0, file$1, 59, 0, 1171);
			attr_dev(input, "type", "text");
			add_location(input, file$1, 75, 8, 1484);
			add_location(button, file$1, 76, 8, 1536);
			attr_dev(div1, "class", "flex svelte-g0dpjv");
			add_location(div1, file$1, 74, 4, 1457);
			attr_dev(div2, "class", "chat-input svelte-g0dpjv");
			add_location(div2, file$1, 73, 0, 1428);
		},
...
function create_each_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$1, 63, 12, 1241);
			attr_dev(div1, "class", "chat");
			add_location(div1, file$1, 66, 12, 1319);
			add_location(hr, file$1, 67, 12, 1367);
			add_location(li, file$1, 62, 8, 1224);
		},
		m: function mount(target, anchor) {
