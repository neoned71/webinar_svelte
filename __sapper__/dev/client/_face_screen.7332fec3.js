import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, o as globals, v as validate_slots, I as get_store_value, K as ApiUrl, J as onMount, T as Token, p as validate_each_argument, e as element, f as claim_element, g as children, b as detach_dev, j as attr_dev, x as add_render_callback, k as add_location, l as insert_hydration_dev, y as select_option, A as listen_dev, C as destroy_each, t as text, h as claim_text, m as append_hydration_dev, u as set_data_dev, w as prop_dev, n as noop, a as space, c as claim_space, D as run_all, F as set_style, q as query_selector_all, E as select_value } from './client.9688e1e7.js';
...
function create_else_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 832, 50, 17979);
			attr_dev(button, "class", "w3-button svelte-1w6fmd6");
			add_location(button, file, 832, 3, 17932);
		},
...
function create_if_block_9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 830, 50, 17876);
			attr_dev(button, "class", "w3-button svelte-1w6fmd6");
			add_location(button, file, 830, 3, 17829);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, i);
...
function create_else_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 838, 52, 18205);
			attr_dev(button, "class", "w3-button svelte-1w6fmd6");
			add_location(button, file, 838, 3, 18156);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, i);
...
function create_if_block_8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 836, 52, 18105);
			attr_dev(button, "class", "w3-button svelte-1w6fmd6");
			add_location(button, file, 836, 3, 18056);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, i);
...
function create_else_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-1w6fmd6");
			add_location(button, file, 844, 3, 18362);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
...
function create_if_block_7(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-1w6fmd6");
			add_location(button, file, 842, 3, 18280);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, t);
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-1w6fmd6");
			add_location(button, file, 851, 3, 18609);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, t);
...
function create_if_block_6(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-1w6fmd6");
			add_location(button, file, 849, 3, 18523);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, t);
...
function create_if_block_5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			if (/*selectedVideoDeviceId*/ ctx[1] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[21].call(select));
			add_location(select, file, 861, 2, 18887);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(861:1) {#if enumeratedDevices}",
		ctx
	});
...
// (864:3) {#each enumeratedDevices as device, i}
function create_each_block_2(ctx) {
	let option;
	let t_value = (/*device*/ ctx[38].label || "camera " + (/*i*/ ctx[40] + 1)) + "";
	let t;
	...
	const block = {
		...
		h: function hydrate() {
			option.__value = option_value_value = /*device*/ ctx[38].deviceId;
			option.value = option.__value;
			add_location(option, file, 864, 4, 19096);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*enumeratedDevices*/ 512 && t_value !== (t_value = (/*device*/ ctx[38].label || "camera " + (/*i*/ ctx[40] + 1)) + "")) set_data_dev(t, t_value);

			if (dirty[0] & /*enumeratedDevices*/ 512 && option_value_value !== (option_value_value = /*device*/ ctx[38].deviceId)) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(864:3) {#each enumeratedDevices as device, i}",
		ctx
	});
...
// (870:1) {#if enumeratedAudioDevices}
function create_if_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(select, "class", "w3-black w3-round w3-select w3-input w3-padding w3-opacity svelte-1w6fmd6");
			if (/*selectedAudioDeviceId*/ ctx[2] === void 0) add_render_callback(() => /*select_change_handler_1*/ ctx[22].call(select));
			add_location(select, file, 870, 2, 19234);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, select, anchor);
			...
			if (!mounted) {
				dispose = listen_dev(select, "change", /*select_change_handler_1*/ ctx[22]);
				mounted = true;
			}
		},
		p: function update(ctx, dirty) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(870:1) {#if enumeratedAudioDevices}",
		ctx
	});
...
// (873:3) {#each enumeratedAudioDevices as device, i}
function create_each_block_1(ctx) {
	let option;
	let t_value = (/*device*/ ctx[38].label || "audio " + (/*i*/ ctx[40] + 1)) + "";
	let t;
	let option_value_value;
	...
	const block = {
		...
		h: function hydrate() {
			option.__value = option_value_value = /*device*/ ctx[38].deviceId;
			option.value = option.__value;
			add_location(option, file, 873, 4, 19449);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, option, anchor);
			append_hydration_dev(option, t);
		...
		p: function update(ctx, dirty) {
			if (dirty[0] & /*enumeratedAudioDevices*/ 1024 && t_value !== (t_value = (/*device*/ ctx[38].label || "audio " + (/*i*/ ctx[40] + 1)) + "")) set_data_dev(t, t_value);

			if (dirty[0] & /*enumeratedAudioDevices*/ 1024 && option_value_value !== (option_value_value = /*device*/ ctx[38].deviceId)) {
				prop_dev(option, "__value", option_value_value);
				option.value = option.__value;
			}
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(873:3) {#each enumeratedAudioDevices as device, i}",
		ctx
	});
...
// (878:1) {#if enumeratedMediaDevices}
function create_if_block_3(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			var option_nodes = children(option);
			t = claim_text(option_nodes, "Select Media");
			option_nodes.forEach(detach_dev);
		...
		h: function hydrate() {
			option.__value = "-";
			option.value = option.__value;
			add_location(option, file, 879, 3, 19700);
			attr_dev(select, "class", "w3-black w3-round w3-select w3-input w3-padding w3-opacity svelte-1w6fmd6");
			if (/*selectedMediaDeviceId*/ ctx[3] === void 0) add_render_callback(() => /*select_change_handler_2*/ ctx[23].call(select));
			add_location(select, file, 878, 2, 19585);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, select, anchor);
			...
			if (!mounted) {
				dispose = listen_dev(select, "change", /*select_change_handler_2*/ ctx[23]);
				mounted = true;
			}
		},
		p: function update(ctx, dirty) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(878:1) {#if enumeratedMediaDevices}",
		ctx
	});
...
// (881:3) {#each enumeratedMediaDevices as device, i}
function create_each_block(ctx) {
	let option;
	let t_value = /*device*/ ctx[38] + "";
	let t;
	...
	const block = {
		...
		h: function hydrate() {
			option.__value = /*device*/ ctx[38];
			option.value = option.__value;
			add_location(option, file, 881, 4, 19791);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, option, anchor);
			append_hydration_dev(option, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(881:3) {#each enumeratedMediaDevices as device, i}",
		ctx
	});
...
// (886:1) {#if enumeratedAudioDevices || enumeratedDevices}
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file, 886, 2, 19915);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(886:1) {#if enumeratedAudioDevices || enumeratedDevices}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(p, "class", "svelte-1w6fmd6");
			add_location(p, file, 827, 1, 17766);
			attr_dev(button, "class", "w3-button svelte-1w6fmd6");
			add_location(button, file, 855, 2, 18777);
			attr_dev(div0, "class", "normal_controls svelte-1w6fmd6");
			add_location(div0, file, 828, 1, 17782);
			attr_dev(div1, "class", "topbar w3-card svelte-1w6fmd6");
			add_location(div1, file, 826, 0, 17736);
			attr_dev(div2, "class", "main svelte-1w6fmd6");
			add_location(div2, file, 902, 2, 20356);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, t0, anchor);
...
function instance($$self, $$props, $$invalidate) {
	...
	function initializeSocket(socket) {
		...
		socket.on('set-primary', data => {
			...
			if (room.primary != data.user && room.masters.includes(data.user)) {
				...
				$$invalidate(19, room.primary = data.user, room);
			}
		}); // 
	...
	async function deviceChangeToMedia(e) {
		console.log(e);
	...
	$$self.$$set = $$props => {
		...
		if ('room' in $$props) $$invalidate(19, room = $$props.room);
	};
...
class Face_screen extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, { socket: 20, user: 0, room: 19 }, null, [-1, -1]);
		...
		if (/*room*/ ctx[19] === undefined && !('room' in props)) {
