import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, o as globals, v as validate_slots, I as get_store_value, K as ApiUrl, J as onMount, T as Token, e as element, t as text, a as space, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, j as attr_dev, k as add_location, l as insert_hydration_dev, m as append_hydration_dev, A as listen_dev, n as noop, D as run_all, F as set_style, q as query_selector_all } from './client.c6feddfe.js';
...
function create_else_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 633, 50, 12508);
			attr_dev(button, "class", "w3-button svelte-10e2mtc");
			add_location(button, file, 633, 3, 12461);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = listen_dev(button, "click", /*toggleMic*/ ctx[8], false, false, false);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block_5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 631, 50, 12405);
			attr_dev(button, "class", "w3-button svelte-10e2mtc");
			add_location(button, file, 631, 3, 12358);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, i);
...
function create_else_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 639, 52, 12734);
			attr_dev(button, "class", "w3-button svelte-10e2mtc");
			add_location(button, file, 639, 3, 12685);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, i);
			...
			if (!mounted) {
				dispose = listen_dev(button, "click", /*toggleVideo*/ ctx[9], false, false, false);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i, file, 637, 52, 12634);
			attr_dev(button, "class", "w3-button svelte-10e2mtc");
			add_location(button, file, 637, 3, 12585);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, i);
...
function create_else_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-10e2mtc");
			add_location(button, file, 645, 3, 12891);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			...
			if (!mounted) {
				dispose = listen_dev(button, "click", /*toggleUsers*/ ctx[10], false, false, false);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-10e2mtc");
			add_location(button, file, 643, 3, 12809);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, t);
...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-10e2mtc");
			add_location(button, file, 652, 3, 13138);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, t);
			...
			if (!mounted) {
				dispose = listen_dev(button, "click", /*toggleMasters*/ ctx[11], false, false, false);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(button, "class", "w3-button svelte-10e2mtc");
			add_location(button, file, 650, 3, 13052);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, button, anchor);
			append_hydration_dev(button, t);
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen_dev(button0, "click", /*controlMuteAll*/ ctx[6], false, false, false),
					listen_dev(button1, "click", /*controlUnmuteAll*/ ctx[7], false, false, false),
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 675, 3, 13814);
			add_location(h20, file, 681, 4, 13963);
			attr_dev(div1, "id", "masters");
			attr_dev(div1, "class", "masters_video svelte-10e2mtc");
			add_location(div1, file, 682, 4, 13984);
			attr_dev(div2, "id", "masters_container");
			set_style(div2, "display", /*showMasters*/ ctx[1] ? "block" : "none");
			attr_dev(div2, "class", "svelte-10e2mtc");
			add_location(div2, file, 680, 3, 13885);
			add_location(h21, file, 688, 4, 14140);
			attr_dev(div3, "id", "users");
			attr_dev(div3, "class", "users_video svelte-10e2mtc");
			add_location(div3, file, 689, 4, 14159);
			attr_dev(div4, "id", "users_container");
			set_style(div4, "display", /*showUsers*/ ctx[2] ? "block" : "none");
			attr_dev(div4, "class", "svelte-10e2mtc");
			add_location(div4, file, 687, 3, 14066);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*showMasters*/ 2) {
				set_style(div2, "display", /*showMasters*/ ctx[1] ? "block" : "none");
			}

			if (dirty & /*showUsers*/ 4) {
				set_style(div4, "display", /*showUsers*/ ctx[2] ? "block" : "none");
			}
		},
		d: function destroy(detaching) {
...
function create_fragment(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*myMic*/ ctx[3]) return create_if_block_5;
	...
	function select_block_type_1(ctx, dirty) {
		if (/*myVideo*/ ctx[4]) return create_if_block_4;
	...
	function select_block_type_2(ctx, dirty) {
		if (!/*showUsers*/ ctx[2]) return create_if_block_3;
	...
	function select_block_type_3(ctx, dirty) {
		if (!/*showMasters*/ ctx[1]) return create_if_block_2;
		return create_else_block;
	}

	let current_block_type_3 = select_block_type_3(ctx);
	let if_block3 = current_block_type_3(ctx);
	let if_block4 = /*isPrimary*/ ctx[5] && create_if_block_1(ctx);
	let if_block5 = /*user*/ ctx[0] && create_if_block(ctx);
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(p, "class", "svelte-10e2mtc");
			add_location(p, file, 628, 1, 12295);
			attr_dev(button, "class", "w3-button svelte-10e2mtc");
			add_location(button, file, 656, 2, 13306);
			attr_dev(div0, "class", "normal_controls svelte-10e2mtc");
			add_location(div0, file, 629, 1, 12311);
			attr_dev(div1, "class", "topbar w3-card svelte-10e2mtc");
			add_location(div1, file, 627, 0, 12265);
			attr_dev(div2, "class", "main svelte-10e2mtc");
			add_location(div2, file, 672, 2, 13774);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, t0, anchor);
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		...
		if (!user || !room || !socket) {
			...
			$$invalidate(5, isPrimary = user.id == room.primary);
			connectSocket();
		}
	});
	...
	async function connectSocket() {
		try {
			...
			if (stream.getTracks().length > 0) {
				$$invalidate(3, myMic = true);
				$$invalidate(4, myVideo = true);
		...
		socket.on('set-primary', data => {
			...
			if (room.primary != data.user && room.masters.includes(data.user)) {
				...
				if (user.id == data.user) {
					$$invalidate(5, isPrimary = true);
				}

				$$invalidate(12, room.primary = data.user, room);
			}
		}); // 
	...
	function toggleUsers() {
		$$invalidate(2, showUsers = !showUsers);
	}

	function toggleMasters() {
		$$invalidate(1, showMasters = !showMasters);
	}
	...
	$$self.$$set = $$props => {
		...
		if ('room' in $$props) $$invalidate(12, room = $$props.room);
	};
	...
	$$self.$inject_state = $$props => {
		...
		if ('showMasters' in $$props) $$invalidate(1, showMasters = $$props.showMasters);
		if ('showUsers' in $$props) $$invalidate(2, showUsers = $$props.showUsers);
		if ('myMic' in $$props) $$invalidate(3, myMic = $$props.myMic);
		if ('myVideo' in $$props) $$invalidate(4, myVideo = $$props.myVideo);
		if ('room' in $$props) $$invalidate(12, room = $$props.room);
		if ('isMaster' in $$props) isMaster = $$props.isMaster;
		if ('isPrimary' in $$props) $$invalidate(5, isPrimary = $$props.isPrimary);
...
class Face_screen extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, { socket: 13, user: 0, room: 12 });
		...
		if (/*room*/ ctx[12] === undefined && !('room' in props)) {
