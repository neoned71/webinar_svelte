import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, o as globals, v as validate_slots, I as get_store_value, K as ApiUrl, J as onMount, T as Token, p as validate_each_argument, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, k as add_location, j as attr_dev, x as add_render_callback, l as insert_hydration_dev, m as append_hydration_dev, y as select_option, A as listen_dev, C as destroy_each, u as set_data_dev, w as prop_dev, n as noop, D as run_all, a as space, c as claim_space, F as set_style, q as query_selector_all, E as select_value } from './client.21beba70.js';
...
function create_if_block_3(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			button = claim_element(nodes, "BUTTON", { class: true });
			var button_nodes = children(button);
			t = claim_text(button_nodes, "cHANGEdevice");
			button_nodes.forEach(detach_dev);
			this.h();
		},
		h: function hydrate() {
...
// (972:1) {#if enumeratedMediaDevices}
function create_if_block_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(972:1) {#if enumeratedMediaDevices}",
		ctx
	});
...
// (975:3) {#each enumeratedMediaDevices as device, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			option.value = option.__value;
			add_location(option, file, 975, 4, 21903);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, option, anchor);
			append_hydration_dev(option, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(975:3) {#each enumeratedMediaDevices as device, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	let if_block7 = /*enumeratedMediaDevices*/ ctx[11] && create_if_block_2(ctx);
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div2, file, 994, 2, 22367);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, t0, anchor);
		...
		p: function update(ctx, dirty) {
			...
			if (/*enumeratedMediaDevices*/ ctx[11]) if_block7.p(ctx, dirty);
